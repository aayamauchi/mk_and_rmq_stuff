#!/usr/bin/python26
# 
# $Id: //sysops/main/puppet/test/modules/nagios/files/ironport/nagios/customplugins/check_dns_qps.py#1 $
#
...
if __name__ == '__main__':
    ...
    cmd_parser.add_option('-o', '--oid', type="string",
            help="Optionally sets the oid to query.", default='1.3.6.1.4.1.2021.8.1')
