...
def add_to_spool():
    ...
    try:
        ...
        try:
            ...
            if '_hostsource_url' in environment:
                try:
                    if 'asdb' in environment['_hostsource_url'].lower():
                        environment['_hostsource_url__asdb'] = '1'
                    if 'cms' in  environment['_hostsource_url'].lower():
                        environment['_hostsource_url__cms'] = '1'
                except:
                    pass
