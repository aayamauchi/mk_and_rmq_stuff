...
:Status: $Id: //sysops/main/puppet/test/modules/nagios/files/ironport/nagios/customplugins/check_crons_table.py#1 $
:Authors: aflury
"""
...
USAGE = """
%s -H <host> -u <user> -p <password> -d <db> -c <critical> -w <warning> [-C <command>]
