...
# updatd.
#
# $Id: //sysops/main/puppet/test/modules/nagios/files/ironport/nagios/customplugins/check_phonehome_stats.py#1 $
#
...
if __name__ == '__main__':
    ...
    if data_dict.has_key('build'):
        # New style stats.
        sorted_keys = data_dict['recent'].keys()
        sorted_keys.sort()
        timekey = sorted_keys[-1]
